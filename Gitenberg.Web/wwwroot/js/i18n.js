...
const DICT = {
  ru: {
    ...
    tocButton: 'Оглавление',
    tocTitle: 'Оглавление',
    tocEmpty: 'В заметке нет заголовков.',
    ...
    themeSepia: 'Сепия',
    themeNord: 'Норд',
    themeDracula: 'Дракула',
    themeSolarLight: 'Соляризованная светлая',
    themeSolarDark: 'Соляризованная тёмная',
    themeOled: 'OLED',
  ...
  en: {
    ...
    themeSolarLight: 'Solarized Light',
    themeSolarDark: 'Solarized Dark',
    themeOled: 'OLED',
