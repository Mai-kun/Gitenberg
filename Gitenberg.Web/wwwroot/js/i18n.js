...
const DICT = {
  ru: {
    ...
    templatesBtnTitle: 'Создать по шаблону',
    templatesTitle: 'Создать по шаблону',
    templatesHint: 'Шаблоны берутся из папки templates/ вашего репозитория. Переменные {{date}}, {{time}} и {{title}} подставляются автоматически.',
    templatesNameLabel: 'Название заметки',
    templatesCreate: 'Создать',
    templatesNameRequired: 'Укажите название заметки.',
    templatesEmpty: 'В папке templates/ пока нет шаблонов.',
    templatesLoadFailed: 'Не удалось загрузить шаблоны',
    templatesSeed: 'Создать примеры шаблонов',
    templatesSeedBusy: 'Создание…',
    templatesSeedDone: 'Примеры шаблонов созданы в папке templates/',
    templatesFallbackName: 'Без названия',
    templateSeeds: [
      {
        name: 'Встреча.md',
      ...
      {
        name: 'План на день.md',
        content: '# План на {{date}}\n\n## Главное\n\n- [ ] \n\n## Задачи\n\n- [ ] \n- [ ] \n- [ ] \n\n## Заметки\n\n- {{time}} — \n',
      },
    ],
    back: 'Назад',
    ...
    themeSepia: 'Сепия',
    themeNord: 'Норд',
    themeHint: 'Тема применяется сразу и запоминается автоматически. «Как в Telegram» повторяет цвета клиента Telegram.',
  ...
  en: {
    ...
    templatesBtnTitle: 'Create from template',
    templatesTitle: 'Create from template',
    templatesHint: 'Templates come from the templates/ folder of your repository. The {{date}}, {{time}} and {{title}} variables are filled in automatically.',
    templatesNameLabel: 'Note title',
    templatesCreate: 'Create',
    templatesNameRequired: 'Enter a note title.',
    templatesEmpty: 'No templates in the templates/ folder yet.',
    templatesLoadFailed: 'Failed to load templates',
    templatesSeed: 'Create sample templates',
    templatesSeedBusy: 'Creating…',
    templatesSeedDone: 'Sample templates created in templates/',
    templatesFallbackName: 'Untitled',
    templateSeeds: [
      {
        name: 'Meeting.md',
        content: '# {{title}}\n\n**Date:** {{date}} · **Time:** {{time}}\n\n## Attendees\n\n## Agenda\n\n- [ ] \n\n## Discussion\n\n## Action items\n\n- [ ] \n',
    ...
    themeSepia: 'Sepia',
    themeNord: 'Nord',
    themeHint: 'The theme applies instantly and is remembered automatically. "Follow Telegram" mirrors the Telegram client colors.',
